...
For [managed access]({% post_url 2015-10-01-access %}#managed%}) cell lines, expression array data
...
For [open access]({% post_url 2015-10-01-access %}#open) cell lines, expression array data files
